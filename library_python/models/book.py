...
This module defines the Book and Review models for managing library books
and their reviews in the system.
"""
...
class Review:
    ...
    Attributes:
        ...
        book_id (str): ID of the book being reviewed.
        rating (int): Rating from 1-5 stars.
        comment (str): Review comment/text.
        date (str): Date when review was submitted.
        user_name (str): Name of the reviewer (loaded from join).
    """
    
    def __init__(self, id: str, user_id: str, book_id: str, rating: int,
                 comment: str, date: str, user_name: Optional[str] = None) -> None:
        ...
        Args:
            ...
            user_name: Reviewer's name (optional).
        """
        self.id = id
    ...
    @staticmethod
    def get_by_book(book_id: str) -> List['Review']:
        ...
        Returns:
            List of Review instances, sorted by date (newest first).
        """
        db = get_db()
        rows = db.execute('''
    ...
    @staticmethod
    def create(user_id: str, book_id: str, rating: int, comment: str) -> bool:
